<div class="container flex flex-col items-center py-8 md:py-16 gap-10">
    ...
    <ul class="flex flex-col md:flex-row w-full gap-5 md:gap-20">
        ...
        <li class="w-full">
            ...
            <p class="text-lg">Kamu bisa mengakses materi via PC, Laptop, Tab, dan HP hanya memerlukan kuota internet
            </p>
        </li>
    </ul>
</div>
