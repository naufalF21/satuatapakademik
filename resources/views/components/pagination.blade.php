<section class="container flex flex-col items-center pb-14">
        ...
        <ul class="inline-flex -space-x-px text-base h-10">
            ...
            <li>
                <a href="#" aria-current="page"
                    class="flex items-center justify-center px-4 h-10 text-base-red border border-gray-300 bg-blue-50 hover:bg-blue-100 hover:text-red-700">3</a>
            </li>
            <li>
                <a href="#"
