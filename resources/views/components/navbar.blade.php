    ...
    <div class="py-5 bg-base-black text-base-white">
        <ul class="container flex flex-row w-full justify-between">
            ...
            <li class="flex flex-row gap-8">
                <a href="#" class="hover:text-base-red">
            ...
            <ul
                ...
                <li>
                    <button id="dropdownNavbarLink" data-dropdown-toggle="dropdownNavbar"
                        class="flex items-center justify-between w-full py-2 px-3 md:hover:bg-transparent md:border-0 md:hover:text-base-red md:p-0 md:w-auto ">Programs
                    ...
                    <div id="dropdownNavbar"
                        ...
                        <ul class="py-2 text-sm" aria-labelledby="dropdownLargeButton">
                            <li>
                                <a href="#" class="block px-4 py-2 hover:bg-gray-100 ">Kelas Film</a>
                            </li>
                        </ul>
                    </div>
                </li>
